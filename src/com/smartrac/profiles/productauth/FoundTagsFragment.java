...
public class FoundTagsFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_foundtags, container, false);
        _listViewResults = (ListView)rootView.findViewById(R.id.listviewResults);
        FoundTagListAdapter adapter = new FoundTagListAdapter(this.getActivity(), _aStatusImage, _asUid);
